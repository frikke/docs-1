...
<AccordionGroup>
  ...
  <Accordion title="How to use Hoppscotch on a desktop?">
    Download the desktop app from [Downloads page](https://hoppscotch.com/downloads) and install it on your desktop. You can also use Hoppscotch on your desktop by visiting [hoppscotch.io](https://hoppscotch.io) and clicking on the "**Install +**" button to install the [Progressive Web App](/documentation/clients/web/overview).
  </Accordion>
</AccordionGroup>
